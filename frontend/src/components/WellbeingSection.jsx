    ...
    <section id="wellbeing" className="relative py-24 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          ...
          >
            Nurture your mind in a <br className="md:hidden" /><em className="text-blue-600">distracted world.</em>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center mb-20 md:mb-32">
          ...
          >
            ...
            <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100 aspect-video lg:aspect-square flex items-center justify-center bg-slate-50">
              ...
              >
                <Play fill="currentColor" size={20} className="ml-1 group-hover/btn:text-blue-500 transition-colors" />
              </motion.button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100 hover:border-indigo-200 transition-colors text-center">
                <h4 className="text-indigo-600 font-black text-xl md:text-2xl mb-1">20%</h4>
                <p className="text-slate-500 text-[10px] font-bold uppercase tracking-wider">Productivity Boost</p>
              </div>
              <div className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100 hover:border-indigo-200 transition-colors text-center">
                <h4 className="text-indigo-600 font-black text-xl md:text-2xl mb-1">45m</h4>
          ...
          >
            ...
            <div className="relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100 aspect-video lg:aspect-square bg-indigo-50 flex items-center justify-center p-6 md:p-12">
               <img 
                src={mindfulBreak} 
                alt="Mindful Breaks" 
