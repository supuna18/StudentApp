        ...
        <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-800 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-16">
                    <div className="bg-indigo-600 p-4 rounded-[1.5rem] shadow-xl shadow-indigo-200 mb-6 animate-bounce">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div 
                        ...
                        className="group relative bg-white rounded-[3rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer overflow-hidden border-b-8 border-b-indigo-500"
                    >
                        {/* Image Layer */}
                        <div className="h-48 w-full rounded-[2rem] mb-8 overflow-hidden relative shadow-inner">
                            <img 
                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <span className="text-[10px] font-black text-indigo-500 uppercase tracking-[0.2em] mb-1 block">Module 01</span>
                                <h2 className="text-3xl font-black text-slate-800 uppercase italic leading-none">Study Groups</h2>
                            </div>
                    ...
                    <div 
                        ...
                        className="group relative bg-white rounded-[3rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer overflow-hidden border-b-8 border-b-emerald-500"
                    >
                        {/* Image Layer */}
                        <div className="h-48 w-full rounded-[2rem] mb-8 overflow-hidden relative shadow-inner">
                            <img 
                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.2em] mb-1 block">Module 02</span>
                                <h2 className="text-3xl font-black text-slate-800 uppercase italic leading-none">Scheduler</h2>
                            </div>
                ...
                <div className="mt-16 flex justify-center">
                    <div className="bg-white/40 backdrop-blur-md px-8 py-4 rounded-[2rem] border border-white/50 flex items-center gap-3 shadow-sm group">
                        <Sparkles className="text-yellow-500 group-hover:rotate-12 transition-transform" size={20} />
