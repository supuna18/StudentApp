            ...
            <div className="pm-root min-h-screen bg-[#F0F6FF] relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
                    ...
                    <div className="flex items-center gap-1.5 text-[11.5px] text-slate-400 mb-6">
                        ...
                        <span className="font-medium text-slate-500">My Profile</span>
                    </div>

                    {/* ── Page header ── */}
                    <div className="mb-8">
                        <h1 className="serif-heading text-[32px] text-[#0F1C4D] italic leading-tight">Profile Settings</h1>
                        <p className="text-[13px] text-slate-500 mt-1.5">Manage your account information, security preferences, and notification settings.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-[240px_1fr] gap-8 items-start">
                        ...
                        {/* ── Left nav ── */}
                        <div className="bg-white border border-[#E8EEFF] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgba(15,28,77,0.04)]">
